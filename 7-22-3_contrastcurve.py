...
#specifically for this observation, need to remove first slice as it has an issue
module = ReshapeModule(name_in='shape_down_science_pre',
...
module = RemoveFramesModule(name_in='slice_science_pre', 
                            ...
                            selected_out_tag='slice_one_removed', 
                            removed_out_tag='trash', 
                            frames=[0])
pipeline.add_module(module)
    ...
    for j, angle in enumerate(angle_space):
        ...
        try:
            res = root_scalar(PlanetInjection, 
                              ...
                              bracket=(initial_guess_pre - 2., 16.),
